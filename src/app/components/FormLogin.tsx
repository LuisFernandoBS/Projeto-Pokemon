...
import { mostrarAlerta } from "../store/features/alerta/alerta-slice.ts";
...
const FormLogin = () => {
  ...
  async function logar({ user, senha }: SignInData) {
    let resp = await axios
      .post("https://api-projeto-pokemon.vercel.app/api/logar", {
        user: user,
        senha: senha,
      })
  ...
  async function consultarUsuario() {
    ...
    let resp = await axios
      .get(
        "https://api-projeto-pokemon.vercel.app/api/usuario/consulta-dados-usuario",
        {
          headers: {
